...
def parse_args():
    ...
    parser.add_argument("--eps_safe", type=float, default=0.2, help="eps_safe")
    parser.add_argument("--eps_unsafe", type=float, default=0.2, help="eps_unsafe")
    parser.add_argument("--safe_loss_weight", type=float, default=1, help="eps_safe")
    parser.add_argument("--unsafe_loss_weight", type=float, default=1.2, help="eps_unsafe")
    parser.add_argument("--action_loss_weight", type=float, default=1, help="eps_unsafe")
...
def main():
    ...
    dataset = Dataset(state_car_dim=2, state_obstacles_dim=2, control_dim=2, buffer_size=1000000)
    ...
    wandb.config.update({
        ...
        "safe_loss_weight": config["safe_loss_weight"],
        "unsafe_loss_weight": config["unsafe_loss_weight"],
    ...
    trainer = Trainer(
        cbf, dataset, 
        # safe_distance=5, 
        eps_safe=config['eps_safe'], ##was 0.1
        eps_unsafe=config['eps_unsafe'], #was 0.1
        safe_loss_weight=config["safe_loss_weight"], 
        unsafe_loss_weight=config["unsafe_loss_weight"], 
        action_loss_weight=config["action_loss_weight"],
        dt=0.1, 
