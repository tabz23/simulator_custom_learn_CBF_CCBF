...
CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_961.pt"#cbf
CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_273.pt"##idbf
# COMPARISON OF ALL METHODS 500 runs
# ==================================================
# Method                              Avg Reward      Avg Cost        Success %       Collision %    
# -----------------------------------------------------------------------------------------------
# BC (All Data)                       82.84±1.55       4.17±0.88       96.2±2.2          21.8±4.2
# BC-Safe (Safe Data Only)            80.90±1.35       0.64±0.20       93.6±3.2          6.4±2.3
# CBF-QP (Goal Reaching)              78.11±1.49       0.00±0.00       89.0±2.3          0.0±0.0
# CBF-QP (BC + CBF)                   82.29±1.12       0.00±0.00       95.2±2.3          0.0±0.0
# CBF-QP (BC-Safe + CBF)              81.04±0.93       0.00±0.00       93.4±1.7          0.0±0.0
# CCBF-QP (Goal Reaching)             78.79±0.75       0.00±0.00       89.2±1.3          0.0±0.0
# CCBF-QP (BC + CBF)                  81.80±0.89       0.00±0.00       94.4±2.1          0.0±0.0
# CCBF-QP (BC-Safe + CBF)             80.78±1.74       0.00±0.00       92.4±3.3          0.0±0.0

CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_961.pt"#cbf
CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_128.pt"##idbf
# COMPARISON OF ALL METHODS 500 runs
# ==================================================
# Method                              Avg Reward      Avg Cost        Success %       Collision %    
# -----------------------------------------------------------------------------------------------
...
# CBF-QP (BC + CBF)                   82.29±1.12       0.00±0.00       95.2±2.3          0.0±0.0
# CBF-QP (BC-Safe + CBF)              81.04±0.93       0.00±0.00       93.4±1.7          0.0±0.0
# CCBF-QP (Goal Reaching)             74.70±0.31       0.00±0.00       82.8±0.8          0.0±0.0
# CCBF-QP (BC + CBF)                  81.56±1.02       0.00±0.00       94.0±2.2          0.0±0.0
# CCBF-QP (BC-Safe + CBF)             80.80±1.75       0.00±0.00       92.4±3.3          0.0±0.0
CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_961.pt"#cbf
CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_341.pt"##idbf
# ==================================================
# COMPARISON OF ALL METHODS 500 runs
# ==================================================
# Method                              Avg Reward      Avg Cost        Success %       Collision %    
...
# CBF-QP (BC + CBF)                   82.29±1.12       0.00±0.00       95.2±2.3          0.0±0.0
# CBF-QP (BC-Safe + CBF)              81.04±0.93       0.00±0.00       93.4±1.7          0.0±0.0
# CCBF-QP (Goal Reaching)             77.94±1.00       0.00±0.00       88.0±1.6          0.0±0.0
# CCBF-QP (BC + CBF)                  81.79±1.13       0.00±0.00       94.4±2.6          0.0±0.0
# CCBF-QP (BC-Safe + CBF)             80.78±1.76       0.00±0.00       92.4±3.3          0.0±0.0

CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_537.pt"#cbf
CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_793.pt"##ccbf
# ==================================================
# COMPARISON OF ALL METHODS 500 runs
# ==================================================
# Method                              Avg Reward      Avg Cost        Success %       Collision %    
...
# BC (All Data)                       82.84±1.55       4.17±0.88       96.2±2.2          21.8±4.2
# BC-Safe (Safe Data Only)            80.90±1.35       0.64±0.20       93.6±3.2          6.4±2.3
# CBF-QP (Goal Reaching)              79.62±1.47       0.00±0.00       91.6±2.7          0.0±0.0
# CBF-QP (BC + CBF)                   82.30±1.12       0.00±0.00       95.2±2.3          0.0±0.0
# CBF-QP (BC-Safe + CBF)              81.26±1.04       0.00±0.00       93.8±1.9          0.0±0.0
# CCBF-QP (Goal Reaching)             77.88±1.30       0.00±0.00       88.6±2.1          0.0±0.0
# CCBF-QP (BC + CBF)                  82.42±1.25       0.00±0.00       95.6±2.8          0.0±0.0
# CCBF-QP (BC-Safe + CBF)             81.02±1.85       0.00±0.00       92.8±3.6          0.0±0.0


#USED THIS IN PAPER, COPIED RESULTS OF CBF (537) INTO TABLE OF OLD IDBF BECAUSE THEY WILL BE SAME
CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_537.pt"#cbf
CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_500.pt"##ccbf
# COMPARISON OF ALL METHODS 500 runs
# ==================================================
# Method                              Avg Reward      Avg Cost        Success %       Collision %    
# -----------------------------------------------------------------------------------------------
...
# CBF-QP (BC + CBF)                   82.30±1.12       0.00±0.00       95.2±2.3          0.0±0.0
# CBF-QP (BC-Safe + CBF)              81.26±1.04       0.00±0.00       93.8±1.9          0.0±0.0
# CCBF-QP (Goal Reaching)             79.63±1.29       0.00±0.00       91.0±2.2          0.0±0.0
# CCBF-QP (BC + CBF)                  82.33±1.17       0.00±0.00       95.4±2.6          0.0±0.0
# CCBF-QP (BC-Safe + CBF)             81.05±1.82       0.00±0.00       92.8±3.6          0.0±0.0

# CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_537.pt"#cbf
# CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_839.pt"##ccbf
# COMPARISON OF ALL METHODS 500 runs
# ==================================================
# Method                              Avg Reward      Avg Cost        Success %       Collision %    
# -----------------------------------------------------------------------------------------------
...
# CBF-QP (BC + CBF)                   82.30±1.12       0.00±0.00       95.2±2.3          0.0±0.0
# CBF-QP (BC-Safe + CBF)              81.26±1.04       0.00±0.00       93.8±1.9          0.0±0.0
# CCBF-QP (Goal Reaching)             73.31±1.25       0.00±0.00       82.6±1.7          0.0±0.0
# CCBF-QP (BC + CBF)                  82.52±1.22       0.00±0.00       95.8±2.8          0.0±0.0
# CCBF-QP (BC-Safe + CBF)             81.26±1.79       0.00±0.00       93.2±3.5          0.0±0.0

CBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_537.pt"#cbf
CCBF_CHECKPOINT="/Users/i.k.tabbara/Documents/python directory/ccbf_ground_truth_checkpoint_24999_816.pt"##ccbf without detach used this for appendix
...
# CBF-QP (BC + CBF)                   82.30±1.12       0.00±0.00       95.2±2.3          0.0±0.0
# CBF-QP (BC-Safe + CBF)              81.26±1.04       0.00±0.00       93.8±1.9          0.0±0.0
# CCBF-QP (Goal Reaching)             79.86±1.87       0.00±0.00       91.6±3.3          0.0±0.0
# CCBF-QP (BC + CBF)                  82.87±0.97       0.00±0.00       96.4±2.3          0.0±0.0
# CCBF-QP (BC-Safe + CBF)             81.29±1.77       0.00±0.00       93.2±3.5          0.0±0.0
...
def evaluate_cbf_qp_controller(controller, env, num_episodes=1, render=True, render_delay=0.001):
    ...
    for episode in range(num_episodes):
        ...
        if render:
            ...
            plt.rc('font', size=15)           # Default text size
            ...
            ax2.set_title('CCBF Values Over Time' ,fontsize=18, fontweight='bold')
            # ax2.set_xlabel('Time Step', fontsize=16)
            ax2.set_ylabel('CCBF Value', fontsize=20)
            ax2.axhline(y=0, color='r', linestyle='-', alpha=0.3)  # Zero line for CBF
            
            # Subplot for x-velocity actions
            ax3 = fig.add_subplot(3, 1, 2)
            ax3.set_title('X-Velocity', fontsize=18, fontweight='bold')
            # ax3.set_xlabel('Time Step', fontsize=16)
            ax3.set_ylabel('Input Value', fontsize=20)
            
            # Subplot for y-velocity actions
            ax4 = fig.add_subplot(3, 1, 3)
            ax4.set_title('Y-Velocity', fontsize=18, fontweight='bold')
            ax4.set_xlabel('Time Step', fontsize=20)
            ax4.set_ylabel('Input Value', fontsize=20)
            

            
            plt.tight_layout()

            cbf_plot, = ax2.plot([], [], 'g-', label='CCBF Value')
            ...
            'frameon': False,  # removes the legend frame completely
            'shadow': False,'framealpha': 0
        }
            # Add legends
            # ax1.legend()
            ax2.legend(**legend_settings)
            ax3.legend(**legend_settings)
            ax4.legend(**legend_settings)
        ...
        if render:
            ...
            fig.savefig(f'cbf_analysis_episode_{episode+1}.png', dpi=300, bbox_inches='tight')
            print(f"Saved CBF analysis image to cbf_analysis_episode_{episode+1}.png")
            env.fig.savefig(f'environment_episode_{episode+1}.png', dpi=300, bbox_inches='tight')
            print(f"Saved environment image to environment_episode_{episode+1}.png")
            plt.ioff()
...
# Prepare the methods and metrics for comparison
    ...
    for method, metrics in zip(methods, all_metrics):
        if metrics is not None:
            reward_tuple, cost_tuple, success_tuple, collision_tuple = metrics['reward'], metrics['cost'], metrics['success_rate'], metrics['collision_rate']
            print(f"{method:<35} {reward_tuple[0]:.2f}±{reward_tuple[1]:.2f} {' '*5} {cost_tuple[0]:.2f}±{cost_tuple[1]:.2f} {' '*5} {success_tuple[0]:.1f}±{success_tuple[1]:.1f} {' '*8} {collision_tuple[0]:.1f}±{collision_tuple[1]:.1f}")
        else:
